// War3Source_Engine_PlayerDeathWeapons.sp
...
/*
public War3Source_Engine_PlayerDeathWeapons_OnMapStart()
{
	MyWeaponsOffset=FindSendPropOffs("CBaseCombatCharacter","m_hMyWeapons");
	if(MyWeaponsOffset==-1)
	{
		PrintToServer("[War3Source:EVO] Error finding weapon list offset.");
	}
	Clip1Offset=FindSendPropOffs("CBaseCombatWeapon","m_iClip1");
	if(Clip1Offset==-1)
	{
		PrintToServer("[War3Source:EVO] Error finding clip1 offset.");
	}
	AmmoOffset=FindSendPropOffs("CBasePlayer","m_iAmmo");
	if(AmmoOffset==-1)
	{
		PrintToServer("[War3Source:EVO] Error finding ammo offset.");
	}
}*/

public bool:War3Source_Engine_PlayerDeathWeapons_InitNatives()
{
...
//}
//public War3Source_Engine_PlayerDeathWeapons_OnClientPutInServer(client)
//{
...
new skipaframe;
// Game Frame tracking
public War3Source_Engine_PlayerDeathWeapons_OnGameFrame()
{
...
/*
public War3Source_Engine_PlayerDeathWeapons_OnWar3EventDeath(victim)
{
...
#if (GGAMETYPE == GGAME_CSS || GGAMETYPE == GGAME_CSGO)
public War3Source_Engine_PlayerDeathWeapons_OnW3TakeDmgAllPre(client, attacker, Float:damage)
{
