...
public APLRes:AskPluginLoad2Custom(Handle:myself,bool:late,String:error[],err_max)
{
	...
	CreateConVar("war3e_version",version,"War3Source:EVO version.",FCVAR_SPONLY|FCVAR_NOTIFY|FCVAR_DONTRECORD);  //removed replicated for test 1/23/2023
	...
	CreateConVar("a_war3_version",Eversion,"War3Source:EVO (base) version.",FCVAR_SPONLY|FCVAR_NOTIFY|FCVAR_DONTRECORD);
